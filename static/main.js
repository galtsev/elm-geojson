...
var author$project$Main$emptyModel = {name: 'Hello'};
...
var author$project$Main$init = elm$core$Basics$always(
	_Utils_Tuple2(author$project$Main$emptyModel, elm$core$Platform$Cmd$none));
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"Nope":[]}}}}})}});}(this));